	...
	public class FFU_BE_Prefab_Nukes {
		...
		public static void UpdateNukeModule(ShipModule shipModule, bool initItemData) {
			...
			switch (shipModule.PrefabId) {
				...
				shipModule.displayName = Core.TT($"Iron Harvest <color=#{colorNukeKin}ff>Kinetic</color> Nuke");
				shipModule.description = Core.TT($"Everything aside from engine is solid tungsten carbide alloy. Perfect as decoy due to immense durability. Impact can leave dents at ship's hull.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Kinetic].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Kinetic].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.02f);
				shipModule.displayName = Core.TT($"Biotic Thorn <color=#{colorNukeKin}ff>Kinetic</color> Nuke");
				shipModule.description = Core.TT($"Semisolid bionic capital missile that uses reactive chemical reagent on impact to breach ship's hull and everything else in its way. Environmentally friendly.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Kinetic].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Kinetic].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.02f);
				shipModule.displayName = Core.TT($"Hunter Killer <color=#{colorNukeKin}ff>Kinetic</color> Nuke");
				shipModule.description = Core.TT($"Mass-produced capital missile that concentrates and releases all destructive energy at one point on impact, that destroys everything in its direction.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Kinetic].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Kinetic].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.02f);
				shipModule.displayName = Core.TT($"Biotic Spike <color=#{colorNukeKin}ff>Kinetic</color> Nuke");
				shipModule.description = Core.TT($"Exotic semisolid bionic capital missile that uses extremely corrosive exotic chemical reagent on impact to breach ship's hull and everything else in its way.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Kinetic].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Kinetic].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.02f);
				shipModule.displayName = Core.TT($"Bright Fury <color=#{colorNukeKin}ff>Kinetic</color> Nuke");
				shipModule.description = Core.TT($"Specialized capital missile made from ultra-hard and ultra-heavy material that utilizes experimental antimatter thrusters to accelerate indefinitely toward the target.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Kinetic].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Kinetic].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.02f);
				shipModule.displayName = Core.TT($"Blackhammer <color=#{colorNukeKin}ff>Kinetic</color> Nuke");
				shipModule.description = Core.TT($"An unconventional capital missile that on near-impact accelerates to the speed of light to generate destructive immense kinetic energy in tandem in a single direction.");
				...
				shipModule.displayName = Core.TT($"Powerpack <color=#{colorNukeEnr}ff>Energy</color> Nuke");
				shipModule.description = Core.TT($"Made from printed steel boiler filled with volatile electronic scrap to the brim. Extremely cheap and extremely fragile, but provides at least some form of electronic warfare.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Energy].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Energy].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.05f);
				shipModule.displayName = Core.TT($"Discharge <color=#{colorNukeEnr}ff>Energy</color> Nuke");
				shipModule.description = Core.TT($"Manually assembled energy capital missile. Overloads shields and modules in the hit area. Fragile and may benefit from synced shots or decoys to distract enemy CIWS.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Energy].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Energy].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.05f);
				shipModule.displayName = Core.TT($"Disruptor <color=#{colorNukeEnr}ff>Energy</color> Nuke");
				shipModule.description = Core.TT($"This capital missile carries a strong energy emission payload that increases its shield overloading capability and effective EMP radius. May zap unprotected crew.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Energy].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Energy].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.05f);
				shipModule.displayName = Core.TT($"Pulse Wave <color=#{colorNukeEnr}ff>Energy</color> Nuke");
				shipModule.description = Core.TT($"An improved energy capital missile that releases a very strong disharmony pulse wave that overloads shields, disables modules and electrifies crew a little bit.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Energy].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Energy].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.05f);
				shipModule.displayName = Core.TT($"Dual Shock <color=#{colorNukeEnr}ff>Energy</color> Nuke");
				shipModule.description = Core.TT($"Specialized energy capital missile that uses resonance EMP generator to release pulse wave that overloads shields, disables modules and seriously electrifies crew.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Energy].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Energy].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.05f);
				shipModule.displayName = Core.TT($"Ion Storm <color=#{colorNukeEnr}ff>Energy</color> Nuke");
				shipModule.description = Core.TT($"Advanced energy capital missile that releases extremely strong electromagnetic pulse wave that overloads shields, disables modules and painfully electrifies crew.");
				...
				shipModule.displayName = Core.TT($"Firepack <color=#{colorNukeThr}ff>Thermal</color> Nuke");
				shipModule.description = Core.TT($"Thermal capital missile that was manually assembled from solidified starfuel, engines and crude armor. On impact effectively sets ship's interiors on fire.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Thermal].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Thermal].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.04f);
				shipModule.displayName = Core.TT($"Fireball <color=#{colorNukeThr}ff>Thermal</color> Nuke");
				shipModule.description = Core.TT($"Improvised thermal capital missile that was made from various munitions and high pressure fuel tanks. Releases pressurized and self-igniting liquid on impact.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Thermal].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Thermal].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.04f);
				shipModule.displayName = Core.TT($"Phosphate <color=#{colorNukeThr}ff>Thermal</color> Nuke");
				shipModule.description = Core.TT($"Old external fuel tank modified into thermal capital missile by welding in engine and additional armor. Contains a lot of self-igniting pressurized liquid that is released on impact.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Thermal].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Thermal].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.04f);
				shipModule.displayName = Core.TT($"Blazefire <color=#{colorNukeThr}ff>Thermal</color> Nuke");
				shipModule.description = Core.TT($"Thermal capital missile that contains specialized solid payload that self-ignites when leaves vacuum environment and comes into contact with other material or gases.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Thermal].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Thermal].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.04f);
				shipModule.displayName = Core.TT($"Firestorm <color=#{colorNukeThr}ff>Thermal</color> Nuke");
				shipModule.description = Core.TT($"Improved thermal capital missile that uses highly radioactive and volatile liquid mixed with exotic materials that rise overall temperature of fires to the extreme levels.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Thermal].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Thermal].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.04f);
				shipModule.displayName = Core.TT($"Hellfire <color=#{colorNukeThr}ff>Thermal</color> Nuke");
				shipModule.description = Core.TT($"Advanced thermal capital missile that uses extremely volatile payload of exotic origin that almost incinerates vacuum itself, when not contained in a specialized environment.");
				...
				shipModule.displayName = Core.TT($"Explopack <color=#{colorNukeTac}ff>Tactical</color> Nuke");
				shipModule.description = Core.TT($"A manually assembled tactical capital missile that does some external and internal damage to ship. Made form combined explosive packs with engines and crude armor.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Tactical].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Tactical].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.03f);
				shipModule.displayName = Core.TT($"Stingray <color=#{colorNukeTac}ff>Tactical</color> Nuke");
				shipModule.description = Core.TT($"Cheap and effective tactical capital missile that was designed centuries. Originally was used by a certain organization that fought off alien invasions since 1994.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Tactical].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Tactical].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.03f);
				shipModule.displayName = Core.TT($"Sub-Seismic <color=#{colorNukeTac}ff>Tactical</color> Nuke");
				shipModule.description = Core.TT($"Originally a mining charge that was used for shattering colossal asteroids. Was found out that it is just as useful as tactical capital missile for shattering ship hulls.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Tactical].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Tactical].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.03f);
				shipModule.displayName = Core.TT($"Commercial <color=#{colorNukeTac}ff>Tactical</color> Nuke");
				shipModule.description = Core.TT($"Improved tactical capital missile that was developed for sake of profit and sold to anybody who can afford it. Self-assembly will result in breach of copyright agreements.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Tactical].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Tactical].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.03f);
				shipModule.displayName = Core.TT($"Avalanche <color=#{colorNukeTac}ff>Tactical</color> Nuke");
				shipModule.description = Core.TT($"Advanced well-armored tactical capital missile that deals decent damage to interior and exterior of the ship, and releases self-igniting shrapnel that damages crew.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Tactical].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Tactical].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.03f);
				shipModule.displayName = Core.TT($"Cataclysm <color=#{colorNukeTac}ff>Tactical</color> Nuke");
				shipModule.description = Core.TT($"Experimental capital missile with cluster warhead filled with 8 sub-munition charges. While each sub-munition charge doesn't have much of an impact, sheer quantity easily makes up for it.");
				...
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.04f);
				shipModule.displayName = Core.TT($"Synthpack <color=#{colorNukeChm}ff>Chemical</color> Nuke");
				shipModule.description = Core.TT($"A manually assembled tactical capital missile that is used to poison and kill crewmembers of hostile ship. Made form combined synthetic packs with engines and crude armor.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Chemical].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Chemical].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.04f);
				shipModule.displayName = Core.TT($"Corrosion <color=#{colorNukeChm}ff>Chemical</color> Nuke");
				shipModule.description = Core.TT($"Chemical capital missiles that releases a splash of extremely corrosive and acidic liquid that melts any organics (such as crew) and light robotic alloy composites.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Chemical].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Chemical].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.04f);
				shipModule.displayName = Core.TT($"Green Mist <color=#{colorNukeChm}ff>Chemical</color> Nuke");
				shipModule.description = Core.TT($"This chemical capital missile releases a huge cloud of corrosive/acidic nanopellets on impact that causes severe damage to the crew and minor damage to everything else.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Chemical].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Chemical].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.04f);
				shipModule.displayName = Core.TT($"Deathmite <color=#{colorNukeChm}ff>Chemical</color> Nuke");
				shipModule.description = Core.TT($"Chemical capital missile of organic origin. Releases a pressurized, environmentally friendly, extremely corrosive liquid on impact that severely damages all crew.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Chemical].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Chemical].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.04f);
				shipModule.displayName = Core.TT($"Acid Rain <color=#{colorNukeChm}ff>Chemical</color> Nuke");
				shipModule.description = Core.TT($"Specialized capital missile that utilizes synthetic, very corrosive and acidic reagent, which is contained under the high pressure and released on capital missile impact.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Chemical].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Chemical].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.04f);
				shipModule.displayName = Core.TT($"Green Death <color=#{colorNukeChm}ff>Chemical</color> Nuke");
				shipModule.description = Core.TT($"Advanced chemical capital missile that contains extremely corrosive, acidic and exotic reagent under the highest pressure possible that is released on impact.");
				...
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.03f);
				shipModule.displayName = Core.TT($"Micromite <color=#{colorNukeBrd}ff>Boarding</color> Nuke");
				shipModule.description = Core.TT($"Experimental capital missile that uses instant-hatching cocoons as payload. Contains small amount of active organic payload: aggressive lifeforms with limited lifespan.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Boarding].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Boarding].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.03f);
				shipModule.displayName = Core.TT($"Deathspore <color=#{colorNukeBrd}ff>Boarding</color> Nuke");
				shipModule.description = Core.TT($"Semi-organic capital missile that has high capacity and suitable internal environment. Contains decent amount of active organic payload: aggressive lifeforms with limited lifespan.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Boarding].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Boarding].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.03f);
				shipModule.displayName = Core.TT($"Infestator <color=#{colorNukeBrd}ff>Boarding</color> Nuke");
				shipModule.description = Core.TT($"Capital missile of unknown origin, but has huge capacity and perfect internal environment. Contains huge amount of active organic payload: aggressive lifeforms with limited lifespan.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Boarding].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Boarding].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.03f);
				shipModule.displayName = Core.TT($"Ramshackle <color=#{colorNukeBrd}ff>Boarding</color> Nuke");
				shipModule.description = Core.TT($"Capital missile developed by pirate factions that especially fond of boarding enemy ships. Filled to brim with scrap-made berserk drones that are more then happy rip and tear everything.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Boarding].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Boarding].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.03f);
				shipModule.displayName = Core.TT($"Apocalypse <color=#{colorNukeBrd}ff>Boarding</color> Nuke");
				shipModule.description = Core.TT($"Capital missile developed by Terran Federation. Densely packed with sturdy, but expendable industrial drones that were reconfigured with military grade software for boarding operations.");
				...
				shipModule.displayName = Core.TT($"Exopack <color=#{colorNukeStr}ff>Strategic</color> Nuke");
				shipModule.description = Core.TT($"A makeshift strategic capital missiles that made from destabilized exotics combined with crude armor, engines and a small fuel tank. Damages hull and overloads modules on impact.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Strategic].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Strategic].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.06f);
				shipModule.displayName = Core.TT($"Satellite <color=#{colorNukeStr}ff>Strategic</color> Nuke");
				shipModule.description = Core.TT($"Improvised strategical capital missile that made by arming an old soviet probe with unstable reactor and packing it to brim with destabilized exotics for better effect.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Strategic].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Strategic].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.06f);
				shipModule.displayName = Core.TT($"Happy World <color=#{colorNukeStr}ff>Strategic</color> Nuke");
				shipModule.description = Core.TT($"A civilian use strategic capital missile with a reduced payload. On impact damages exterior and interior of the ships, ignites objects, damages crew and releases EMP blast wave.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Strategic].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Strategic].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.06f);
				shipModule.displayName = Core.TT($"SS-18 Satan <color=#{colorNukeStr}ff>Strategic</color> Nuke");
				shipModule.description = Core.TT($"Ancient strategic capital missile that dates back to 1974, but still printed and used even to this day for its high area of effect, damage capacity and released EMP wave.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Strategic].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Strategic].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.06f);
				shipModule.displayName = Core.TT($"White Death <color=#{colorNukeStr}ff>Strategic</color> Nuke");
				shipModule.description = Core.TT($"Modern military-grade strategic capital missile that was developed not so long ago. Ignites objects, damages modules, crew and hull, and releases strong EMP wave on impact.");
				...
				if (!FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Strategic].Contains(shipModule.PrefabId)) FFU_BE_Defs.nukeTypeIDs[Core.NukeType.Strategic].Add(shipModule.PrefabId);
				if (!FFU_BE_Defs.moduleEmissionPrefabs.ContainsKey(shipModule.PrefabId)) FFU_BE_Defs.moduleEmissionPrefabs.Add(shipModule.PrefabId, 0.06f);
				shipModule.displayName = Core.TT($"Void Fire <color=#{colorNukeStr}ff>Strategic</color> Nuke");
				shipModule.description = Core.TT($"Experimental strategic capital missile that contains huge exotic payload that turns into overwhelming antimatter energy on impact with severe consequences for the target.");
				...
				shipModule.displayName = $"(NUKE) {shipModule.name}";
				break;
			}

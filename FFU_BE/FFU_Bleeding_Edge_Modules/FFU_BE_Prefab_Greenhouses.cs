	...
	public class FFU_BE_Prefab_Greenhouses {
		...
		public static void UpdateGreenhouseModule(ShipModule shipModule, bool initItemData) {
			...
			switch (shipModule.PrefabId) {
				...
				if (!FFU_BE_Defs.economyTypeIDs[Core.EconomyType.Greenhouse].Contains(shipModule.PrefabId)) FFU_BE_Defs.economyTypeIDs[Core.EconomyType.Greenhouse].Add(shipModule.PrefabId);
				...
				shipModule.displayName = Core.TT($"Makeshift <color=#{colorGarden}ff>Greenery</color>");
				shipModule.description = Core.TT($"A very fragile artificial environment for growing bio-engineered lichen. Uses excess heat generated during interstellar travel for production.");
				...
				shipModule.displayName = Core.TT($"Standard <color=#{colorGarden}ff>Greenery</color>");
				shipModule.description = Core.TT($"Artificial environment for growing bio-engineered plants. Uses excess heat generated during interstellar travel for production.");
				...
				shipModule.displayName = Core.TT($"Mushroom <color=#{colorGarden}ff>Hothouse</color>");
				shipModule.description = Core.TT($"Artificial environment for growing bio-engineered mushrooms. Uses excess heat generated during interstellar travel for production.");
				...
				shipModule.displayName = Core.TT($"Farmland <color=#{colorGarden}ff>Greenhouse</color>");
				shipModule.description = Core.TT($"Artificial environment for growing bio-engineered plants with best operator capacity. Uses excess heat generated during interstellar travel for production.");
				...
				shipModule.displayName = Core.TT($"Replicator <color=#{colorGarden}ff>Greenhouse</color>");
				shipModule.description = Core.TT($"Artificial environment for growing bio-engineered plants with best growth rate. Uses excess heat generated during interstellar travel for production.");
				...
				shipModule.displayName = Core.TT($"Exogenetic <color=#{colorGarden}ff>Greenhouse</color>");
				shipModule.description = Core.TT($"Artificial environment for growing highly nutritious bio-engineered exotic plants. Uses excess heat generated during interstellar travel for production.");
				...
				shipModule.displayName = $"(GARDEN) {shipModule.name}";
				break;
			}
